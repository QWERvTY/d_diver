				...
				function(event) {
					...
					$.ajax({
						...
						success : function(isDup) {
							...
							if (isDup) {// id중복
								$('span#dupCheck').html('이미 존재하는 아이디입니다.').css(
										'color', 'red');
							} else { // id중복아님
								$('span#dupCheck').html('사용 가능한 아이디입니다.').css(
										'color', 'green');
							}
...
<script>
	...
	function idDupCheck() {
		...
		// 현재 창 기준으로 새 창 열기
		var childWindow = window.open('/member/joinIdCheck?userid=' + id, '',
				...
				<div class="col-lg-6" style="margin: auto;">
					...
					<div class="col-md-6">
						<input type="text" placeholder="E-mail">
								...
								<div class="col-md-12">
									<form action="/member/join" method="post" id="join" name="frm" onsubmit="return formCheck();">
<fieldset>
